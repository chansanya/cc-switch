...
### Benutzerdefinierter Windows-Konfigurationsmanager für Claude Code, Codex und Pi
...
> **Hinweis zur Custom Edition:** Diese Übersetzung beschreibt die vollständige Upstream-Version und entspricht nicht dem Funktionsumfang dieses Forks. Die aktuelle Custom Edition unterstützt nur Claude Code, Codex und Pi unter Windows. Maßgeblich ist die [chinesische README](README_ZH.md).
